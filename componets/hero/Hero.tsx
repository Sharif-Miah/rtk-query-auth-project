  ...
  <section className="relative h-screen bg-gray-900">
    ...
    <div className="relative h-full flex items-center justify-center text-center px-6">
      <div>
        ...
        <h1 className="text-white text-6xl md:text-7xl font-bold mb-16">
          We're finishing!
        </h1>
          ...
          <ul className="space-y-3">
            <li className="flex items-start gap-2">
              ...
              <span className="text-gray-700">
                Modern and safe architecture with high quality materials
              </span>
            </li>
            <li className="flex items-start gap-2">
              <Check className="w-5 h-5 text-green-600 mt-1 flex-shrink-0" />
              <span className="text-gray-700">
                Strategic location near shopping centers and schools
              </span>
            </li>
            <li className="flex items-start gap-2">
              <Check className="w-5 h-5 text-green-600 mt-1 flex-shrink-0" />
              <span className="text-gray-700">
                Premium facilities including gym, pool, and park
              </span>
            </li>
          </ul>
        </div>
...
const ProgressItem: React.FC<ProgressItemProps> = ({
  ...
  <div className="flex items-center gap-3">
    ...
    <span
      className={`text-sm font-medium ${isActive ? "text-black" : "text-gray-400"}`}
    >
      {title}
    </span>
  </div>
        ...
        <div className="flex flex-col justify-center">
          <div className="mb-8">
            ...
            <p className="text-gray-600 leading-relaxed">
              Spacious garage for two cars with beautiful landscaped garden
              area. Perfect for family gatherings and outdoor activities.
            </p>
          </div>
          <div>
            <h3 className="text-xl font-bold mb-3">02. Vertical living</h3>
            <p className="text-gray-600 leading-relaxed">
              Modern vertical architecture maximizing space utilization while
      ...
      <div className="grid md:grid-cols-2 gap-12">
        <div className="flex flex-col justify-center order-2 md:order-1">
          ...
          <p className="text-gray-600 leading-relaxed mb-6">
            Experience luxury living with our thoughtfully designed interiors.
            Every detail is crafted to provide maximum comfort and style for
            modern families.
          </p>
          <p className="text-gray-600 leading-relaxed">
            From spacious living areas to state-of-the-art kitchens, our homes
            are built with your lifestyle in mind.
          </p>
        </div>
...
const PricingCard: React.FC<PricingCardProps> = ({
  ...
  <div
    className={`bg-white rounded-lg p-8 ${isPopular ? "ring-2 ring-green-500 relative" : ""}`}
  >
    {isPopular && (
  ...
  const faqs: FAQItemProps[] = [
    {
      ...
      answer:
        "IFRS 16 is an International Financial Reporting Standard promulgated by the International Accounting Standards Board providing guidance on accounting for leases.",
    },
    {
      question:
        "Is someone on the availability of the IFRS team from questions?",
      answer:
        "Yes, our IFRS team is available to answer your questions during business hours. You can reach them via email or phone.",
    },
    {
      question:
        "Can I request demos of your IFRS team and ask in-depth questions?",
      answer:
        "Absolutely! We offer comprehensive demos and consultation sessions. Contact us to schedule a meeting with our team.",
    },
  ];
  ...
  <section className="py-20 px-6 bg-gray-900 text-white">
    <div className="max-w-4xl mx-auto text-center">
      <h2 className="text-3xl md:text-4xl font-bold mb-4">
        Sed ut ipsum mi volutpat duis ut diam rhoncus amet amet et quis.
        Vestibulum quis varius cursus ut rhoncus vitae.
      </h2>
      ...
      <div className="grid grid-cols-2 md:grid-cols-5 gap-8 mb-12">
        <div className="flex flex-col items-center">
          <Image
            ...
            width={48}
            height={48}
            className="h-12 mb-2 opacity-60"
          />
        </div>
        <div className="flex flex-col items-center">
          <Image
