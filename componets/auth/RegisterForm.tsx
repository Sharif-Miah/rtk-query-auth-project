...
const RegisterForm = () => {
  ...
  const handleSubmit = () => {
    console.log('Register submitted', {fullName, email, password, rememberMe });
  };
      ...
      <div className="space-y-6">
        <div>
          ...
          <div className="relative">
            ...
            />
            <User strokeWidth={1} className="absolute right-4 top-1/2 transform -translate-y-1/2 text-gray-400 w-5 h-5" />
          </div>
        </div>
        <div>
          <label className="block text-sm font-medium text-gray-700 mb-2">
          ...
          <div className="relative">
            <input
              ...
              className="w-full px-4 py-3 pr-12 border border-gray-300 text-black rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition"
            />
